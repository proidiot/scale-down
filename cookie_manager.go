...
type CookieManager interface {
	...
	CookieCheck(cke *http.Cookie) bool
	CookieAuthenticated(cke *http.Cookie)
	GenXSRF(cke *http.Cookie) string
	CheckXSRF(cke *http.Cookie, xsrf string)
}
